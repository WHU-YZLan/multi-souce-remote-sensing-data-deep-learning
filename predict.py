...
from mydataloader import get_image_array, get_segmentation_array, class_colors, get_pairs_from_paths
...
def model_from_checkpoint_path(checkpoints_path):
    ...
    model = model_from_name[model_config['model_class']](
        n_classes=model_config['n_classes'], input_height=model_config['input_height'],
